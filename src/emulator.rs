...
impl Emulator {
    ...
    fn emulate_instruction(&mut self, instruction: Instruction) {
        match instruction {
    ...
    fn emulate_stm(&mut self, a: Register, b: Register) {
    ...
    /// In other words, it performs `a = *b`.
    fn emulate_ldm(&mut self, a: Register, b: Register) {
    ...
    fn emulate_cmp(&mut self, a: Register, b: Register) {
    ...
    /// match.
    fn emulate_jmp(&mut self, condition: u8, register: Register) {
    ...
    /// `register`.
    fn emulate_sys(&mut self, syscall: u8, register: Register) {
    ...
    fn syscall_open(&mut self, path_address: u8) -> u8 {
    ...
    fn syscall_read_memory(&mut self, fd: u8, start: u8, num_bytes: u8) -> u8 {
    ...
    fn syscall_write(&mut self, fd: u8, start: u8, size: u8) -> u8 {
        let bytes_written = unsafe {
            let mut file = File::from_raw_fd(fd.into());
            let n = file
                .write(&self.memory[start..start + size])
